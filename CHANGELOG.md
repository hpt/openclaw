...
- Device pair: require owner access for `/pair approve` on external messaging channels so command-authorized non-owners cannot mint paired-device credentials.
