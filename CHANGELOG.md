...
- Agents/config persist: overlay agent create/update/delete mutations onto a fresh config snapshot so concurrent keys added during workspace bootstrap or identity writes are not wiped by merge-patch deletions.
