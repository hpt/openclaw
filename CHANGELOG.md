...
- Config/persist: overlay configure, onboard, and `openclaw update --channel` writes onto a fresh disk snapshot so concurrent keys added during prompts or package install are not wiped.
