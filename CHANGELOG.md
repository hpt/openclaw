...
- Sessions/store: stop heartbeat and voice-call writers from saving stale full-store snapshots that could clobber concurrent session updates (routing, model overrides, sibling sessions).
