...
- CLI/channels remove: overlay only intended channel-disable/delete mutations onto a fresh config snapshot before persist so concurrent keys written during on-demand catalog plugin install are not wiped.
