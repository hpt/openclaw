...
- Gateway/OpenResponses: keep `previous_response_id` continuity scoped to the request's `user` value as well as its gateway credential, preventing chained requests from crossing user sessions.
