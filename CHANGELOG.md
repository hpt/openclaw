...
- Phone control: require owner access for `/phone arm` and `/phone disarm` on external messaging channels so command-authorized non-owners cannot temporarily enable high-risk node commands.
