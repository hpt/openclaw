...
- CLI/channels: persist `openclaw channels add` mutations onto a fresh config snapshot so npm plugin install cannot wipe concurrent keys such as MCP servers or other channel accounts.
